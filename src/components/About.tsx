...
const VideoPlayer = () => {
  ...
  return (
    <div className="relative h-36 lg:h-[395px] w-full mx-auto">
      <video
        src={restaurantData.about.video}
